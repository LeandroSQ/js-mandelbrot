(module
 ...
 (func $src/assembly/mandelbrot/render (param $0 i32) (param $1 i32) (param $2 f32) (param $3 f32) (param $4 f32) (param $5 i32) (param $6 f32) (param $7 f32)
  (local $8 f32)
  (local $9 f32)
  (local $10 i32)
  (local $11 i32)
 ...
 (func $~start
  i32.const 6152
  global.set $src/assembly/mandelbrot/offset
 )
)
